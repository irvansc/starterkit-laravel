                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('users.show', $user->username) }}" class="btn btn-primary btn-sm"
                                        data-toggle="tooltip" title="Lihat User"><i class="mdi mdi-eye"></i>
                                    </a>
                                    <a class="btn btn-warning btn-sm" wire:click.prevent='editUser({{ $user }})'
                                        data-toggle="tooltip" title="Edit User"><i class="mdi mdi-pencil"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" wire:click.prevent='deleteUser({{ $user }})'
                                        data-toggle="tooltip" title="Hapus User"><i class="mdi mdi-delete"></i>
                                    </a>
                                </td>
                            </tr>
                            @empty
