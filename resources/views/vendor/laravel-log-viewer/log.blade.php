...
<head>
    ...
    <title>Starterkit - Laravel Log Viewer</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col sidebar mb-3">
                <h1><i class="fa fa-calendar" aria-hidden="true"></i> Starterkit - Laravel Log Viewer</h1>
                <p class="text-muted"><i>by Starterkit</i></p>
